...
import { WysiwygTypeComponent } from './dynamic-form/wysiwyg.component';
...
export function minValidationMessage(err, field) {
  return `Inserire un valore uguale o maggiore di ${field.templateOptions.min}`;
}

export function maxValidationMessage(err, field) {
  return `Inserire un valore uguale o minore di ${field.templateOptions.max}`;
}
  ...
  imports: [
    ...
    FormlyModule.forRoot({
      types: [
        {
          name: 'wysiwyg',
          component: WysiwygTypeComponent,
          wrappers: ['form-field'],
        },
        {
          name: 'button',
