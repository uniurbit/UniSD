...
// </fascicolo>
  ...
  //rimuove il fascicolo con numero di protocollo ma non il suo contenuto
  public function rimuoviFascicolo($id) {
    
      $response = $this->soapWrapper->call('titulus.deleteFolder', [
        'id' => $id       
      ]);      
