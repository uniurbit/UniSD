...
{    
    ...
    public $selectcolumns = array('nome','cognome', 'matricola', 'aff_org', 'email','cd_ruolo'. 'id_ab','cod_fis','cd_genere');

    public static function boot()
    {
        parent::boot();
        static::addGlobalScope('Fetch', function ($builder) {
            $builder->select(['nome','cognome', 'matricola', 'aff_org', 'email','cd_ruolo', 'V_IE_RU_PERSONALE.id_ab as id_ab','cod_fis','cd_genere','ds_ssd','cd_ssd']);
        });
    }
